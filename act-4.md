...
Make sure to take note of the dot (.) before zuko-qualities to specify the class you want to alter in your CSS file.
...
[NEXT STEP: Next Steps](https://uviclibraries.github.io/html-css/act-5.html){:.btn .btn-blue }
